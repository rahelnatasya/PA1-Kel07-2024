...
<head>
    ...
    <title>@yield('title') Manajemen Rekayasa</title>
    ...
    <!-- DataTables {{URL::asset('aset/img/wp1.png')}}-->
    <link rel="stylesheet" href="/assets/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="/assets/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet" href="/assets/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('aset/css/adminlte.min.css') }}">
</head>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/dashboard" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Manajemen Rekayasa</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="/tenagakerja" class="nav-link">
